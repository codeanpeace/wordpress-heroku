...
$meta_boxes[] = array(
	'id'		=> 'ct_post_settings',
	'title'		=> __('General Post Settings ("Background Color" and "Font Color" parameters only for Standard or Image post formats without Featured Image)', 'color-theme-framework'),	
	'pages'		=> array( 'post' ),
	'context'	=> 'normal', // Where the meta box appear: normal (default), advanced, side. Optional.
	'priority'	=> 'high',
	'fields'	=> array(
		array(
			...
			'type'		=> 'color',
			'desc'		=> __('Select a custom background color for the post.', 'color-theme-framework'),
			'std'		=> '#DB5858',
		),
		array(
			...
			'type'		=> 'color',
			'desc'		=> __('Select a custom font color for the post.', 'color-theme-framework'),
			'std'		=> '#363636',
		),
		// CHECKBOX
		array(
			...
			'desc'		=> __('If 0 chars, Length of Excerpt will be used from Back-end Theme Options', 'color-theme-framework'),
			'type'		=> 'slider',
			'prefix'	=> '',
			'suffix'	=> ' chars',
			'std'		=> '0',
	...
	'fields' => array(
		...
		array(
			...
			'options'  => array(
				...
				'admin_review_post' => __('Admin Review Post', 'color-theme-framework')
			),
		...
		array(
			'name'		=> __('Review Block Position', 'color-theme-framework'),
			'desc'		=> __('Choose position for the Review Block', 'color-theme-framework' ),
			'id'		=> "{$prefix}review_position",
			'type'		=> 'select',
			'std'		=> __('Select an Item', 'color-theme-framework'),
			'options'	=> array(
				'before_media'	=> 'Before Media Content',
		...
		// COLOR
		array(
			'name' => __('Color for Score Stars (only for Admin Review Post)', 'color-theme-framework'),
