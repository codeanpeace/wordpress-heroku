...
?>
		...
		<div class="row-fluid">
			<div class="page-title-bar">
				<div class="container">
						<h1 class="archive-title"><?php printf( __( 'Search Results for: %s', 'color-theme-framework' ), '<span>' . get_search_query() . '</span>' ); ?></h1>
				</div> <!-- /container -->
			</div> <!-- /page-title-bar -->
		</div> <!-- /row-fluid -->
			...
			<div class="clear"></div>
 					...
 					<div class="post-not-found clearfix">
					  ...
					  ?>
						  ...
						  <h3><?php _e( 'Sorry, but nothing matched your search criteria. Please try again with some different keywords.', 'color-theme-framework' ); ?></h3>
						  <div class="clear"></div>
						  <?php get_search_form(); ?>
						<?php } ?>	
					 </div> <!-- /post-not-found -->
